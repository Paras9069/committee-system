...
export default function AddChat(){
    ...
    const fetchData = ()=>{
         let user={
          ...
          fromId:'662a0bd3fcce0630b2675148',
          toId:sessionStorage.getItem('customerId')
         }
        ApiServices.Singlechat(user)
        .then((res)=>{
            console.log(res)
       ...
       const Submitted=(e)=>{
        ...
        let data= {
         message:message,
        "fromId": sessionStorage.getItem('customerId'),
      ...
      style={{ backgroundImage: 'url("assets/img/hero-bg.jpg")', marginTop:"100px", height:"400px" }} >
          ...
          <div className="container my-5">
                  ...
                  {sortedData?.map((el) => (
                   ...
                   <MessageBox
                   position={el.fromId === '662a0bd3fcce0630b2675148' ? "left" : "right"}
                   type={"text"}
            ...
            {data?.filter(el=>el.fromId==sessionStorage.getItem('customerId')).map((el)=>
                        <div className="col-md-12">
                        <MessageBox
                        position={"right"}
                        type={"text"}
